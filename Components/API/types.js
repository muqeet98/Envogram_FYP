...
export const Follow_Unfollow = 'https://envogram.softgear.site/api/user/follow-unfollow-user'
export const url = 'https://envogram.softgear.site/api/auth/'
export const userByName = 'https://envogram.softgear.site/api/user-by-name/' 
export const userPostAPI = 'https://envogram.softgear.site/api/user/posts-by-user/'
export const url1 = 'https://envogram.softgear.site/api/user/posts-by-visibility/'
export const urlPost = 'https://envogram.softgear.site/api/user/posts'
export const urlProfile = 'https://envogram.softgear.site/api/user/'
export const userProfile =  'https://envogram.softgear.site/api/user/user-profile-with-followers-followingcheck/'
export const userByDepartment = 'https://envogram.softgear.site/api/user-by-department/'
export const urlMessages = 'https://envogram.softgear.site/api/user/messages/'
export const urlUpdateProfile = 'https://envogram.softgear.site/api/user/update-profile/'
export const sendRequest = 'https://envogram.softgear.site/api/user/chat-request'
export const acceptChatReq= 'https://envogram.softgear.site/api/user/accept-chat-request/'
export const deleteChatReq= 'https://envogram.softgear.site/api/user/chat-request/' 
export const allusers= 'https://envogram.softgear.site/api/users'
